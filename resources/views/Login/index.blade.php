        ...
        <div
            ...
            <div class="w-full p-7 sm:p-14 my-auto">
                <div class="mb-12 text-center">
                    <h3 class="text-3xl font-bold uppercase">LOGIN</h3>
                </div>
                ...
                <form action="/login" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="relative mt-2" x-data="{ showPass: false }">
                        <input
                    ...
                    <p class="mt-6 text-sm text-gray-600 text-center">
                        ...
                        <a href="/register" class="font-bold text-red-600 hover:underline">Register</a>
                    </p>
                </form>
            ...
            <div class="w-full bg-red-100 text-center hidden md:flex items-center sm:p-14">
                <div class="w-full">
                    <img src="../img/login.svg" class="w-full object-cover" alt="Login Illustration">
                </div>
            </div>
        </div>
    </div>
